...
class CommentInfoDAOImplTest extends TestCase
{
    ...
    public function testInsert()
    {
        ...
        self::assertEquals($this->commentInfo->targetId, $commentInfo->getTargetId());
    }
    ...
    public function testUpdate()
    {
        ...
        self::assertEquals($this->commentInfo->targetId, $new->getTargetId());
    }
