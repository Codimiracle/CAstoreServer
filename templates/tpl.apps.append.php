                    ...
                    <div class="app-powerpoint">
                        ...
                        <div class="body">
                            <ul class="list-inline">
                                <li><img class="img-responsive" src="static/images/avatar-default.png" /></li>
                                <li><img class="img-responsive" src="static/images/avatar-default.png" /></li>
                                <li><img class="img-responsive" src="static/images/avatar-default.png" /></li>
                                <li><img class="img-responsive" src="static/images/avatar-default.png" /></li>
                            </ul>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="post" role="form">
                        ...
                        <div class="form-group">
                            <label for="title">应用标题</label>
                            <input id="title" type="text" class="form-control" name="title" />
                            <p class="help-block">应用在列表中显示的标题</p>
                        </div>
                        <div class="from-group">
                            <label for="package">应用包名</label>
                        ...
                        <div class="form-group">
                            ...
                            <input id="developer" type="text" class="form-control" name="developer" />
