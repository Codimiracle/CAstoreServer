            ...
            <form method="post" role="form">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="username" type="text" pattern="[A-Za-z0-9]{8,13}" class="form-control" name="username" placeholder="用户名" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="radio">
                                <label><input type="radio" name="gender" checked="checked" value="0"/>保密</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="checkbox">
                                <label><input type="checkbox" name="license" />我同意 <a href="?node=/About/License" target="_blank">《CAstore 服务条款》</a></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-default" name="user_sign_up" value="user_sign_up">提交</button>
                    </div>
                </div>
            </form>
        </div>
